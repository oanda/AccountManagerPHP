        ...
        <div id="mainContainer">
            ...
            <div id="openTrade">
	            ...
	            if(!count($api->openTrade)) {
					...
					$date = new DateTime($element['time'], new DateTimeZone("America/Toronto"));
		            foreach($api->openTrade as $element) {
			            ...
			            echo "<label class='direction'>Type: ".ucfirst($element['side'])."</label>";
			            echo "<label class='date'>".$date->format('g:ia \o\n l jS F Y')."</label>";
			            echo "<div class='clear'></div>";
			            echo "</span>";
		            }
	            }
